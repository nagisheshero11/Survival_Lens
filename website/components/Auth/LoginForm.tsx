...
const inputClass = "w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-2xl text-[15px] font-medium text-slate-900 placeholder-slate-400 transition-all outline-none";
const labelClass = "block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-2.5 ml-1";
...
export default function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 sm:p-12 w-full max-w-[480px] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-slate-100 relative z-10 mx-auto">
      ...
      <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); router.push('/dashboard'); }}>
        ...
        <AnimatePresence mode="wait">
          {/* ── STANDARD fields ── */}
          {method === "standard" && (
            <motion.div key="standard" className="space-y-6"
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-12 pr-14 py-4 bg-slate-50 border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 rounded-2xl text-sm font-medium text-slate-900 tracking-widest placeholder-slate-400 transition-all outline-none"
                  />
            ...
            >
              ...
              {!otpSent && (
                <button type="button"
                  ...
                  className="w-full border-2 border-slate-200 text-slate-700 font-bold py-4 rounded-2xl hover:bg-slate-50 hover:border-blue-200 hover:text-blue-600 transition-all text-[15px] flex items-center justify-center gap-2 group"
                >
                  <MessageSquare size={18} className="group-hover:text-blue-500 transition-colors" />
                  Request OTP Code
                </button>
              )}
        ...
        <div className="pt-4">
          <button type="submit"
            className="w-full bg-slate-900 hover:bg-black text-white font-bold py-4 rounded-2xl hover:-translate-y-0.5 transition-all text-[15px] mb-8 flex justify-center items-center gap-2 shadow-xl shadow-slate-900/10 group group-active:scale-[0.98]"
          >
