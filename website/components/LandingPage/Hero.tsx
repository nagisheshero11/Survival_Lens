        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5 mb-14">
              ...
              <button className="bg-white hover:text-slate-900 text-slate-700 font-bold py-4 px-8 rounded-full transition-all flex items-center justify-center hover:bg-slate-50 border border-slate-200 shadow-sm">
